...
fig.tight_layout()
save_file = os.path.join(dev_name, 'plot_KLOE_CS.png')
...
ax1.errorbar(dataX, df['FF'], yerr=df['deltaFF'], marker='.', linestyle='', markersize=6)

plt.legend()
fig.tight_layout()
save_file = os.path.join(dev_name, 'plot_KLOE_FF.png')
fig.savefig(save_file, dpi=150)
